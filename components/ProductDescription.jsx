        ...
        <div className="my-18 text-sm text-slate-600">
            ...
            {selectedTab === "Reviews" && (
                <div className="flex flex-col gap-3 mt-14">
                    {product.ratings && product.ratings.map((item,index) => (
                        <div key={index} className="flex gap-5 mb-10">
                            ...
                            <div>
                                ...
                                <p className="text-sm max-w-lg my-4">{item.reviewText}</p>
            ...
            <div className="flex gap-3 mt-14">
                <Image src={store.logo} alt="" className="size-11 rounded-full ring ring-slate-400" width={100} height={100} />
                <div>
                    <p className="font-medium text-slate-600">Product by {store.name}</p>
